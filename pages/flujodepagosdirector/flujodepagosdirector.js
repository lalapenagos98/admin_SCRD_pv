...
//        limpiarFormulario();
    ...
    $("#aprobar_pago").click(function () {
        aprobar_pago_ganador_director(token_actual, $('#id_propuesta_director').val(), $('#observacion_verificacion_director').val());
//        limpiarFormulario();
    });
    ...
    $("#devolver_al_misional").click(function () {
        devolver_al_misional(token_actual, $('#id_propuesta_director').val(), $('#observacion_verificacion_director').val());
        $('#complementar_informacion').modal('hide');
//        limpiarFormulario();
    });
    ...
    if (authenticated === false) {
        ...
        if (typeof keycloak === 'object') {
            ...
            permiso_lectura_keycloak(token_actual.token, "SICON-PAGOS-DIRECTOR");
...
function init(token_actual) {
    ...
    $.ajax({
        ...
        url: url_pv + 'Flujodepagosdirector/init/'
    }).done(function (data) {
...
function cargar_select_convocatorias(token_actual, anio, entidad) {
    ...
    $.ajax({
        type: 'POST',
        url: url_pv + 'Flujodepagosdirector/select_convocatorias',
...
function cargar_select_categorias(token_actual, convocatoria) {
    ...
    $.ajax({
        type: 'POST',
        url: url_pv + 'Flujodepagosdirector/select_categorias',
...
function cargar_select_grupos(token_actual, ronda) {
    ...
    $.ajax({
        type: 'GET',
        url: url_pv + 'Flujodepagosdirector/select_grupos',
...
function cargar_tabla(token_actual) {
    ...
    $('#table_list').DataTable({
        ...
        "ajax": {
            type: 'POST',
            url: url_pv + "Flujodepagosdirector/all_propuestas_ganadoras",
            data:
...
function cargar_info_basica(token_actual, id_propuesta) {
    ...
    $.ajax({
        type: 'POST',
        url: url_pv + 'Flujodepagosdirector/propuestas_ganadoras/' + id_propuesta,
        data: {"token": token_actual.token},
    }).done(function (data) {
        ...
        switch (data) {
            ...
            default:
                ...
                if (json.propuesta) {
                    ...
                    $("#id_propuesta_director").attr("value", json.propuesta.id);
                    ...
                    $("#monto_asignado").attr("value", json.propuesta.monto_asignado);
                    $("#observacion_verificacion_director").attr("value", json.propuesta.observaciones_documentos_director);
...
//                                                        alert ($("#info_comp").attr('value'));
                ...
                $(".download_file").click(function () {
                    ...
                    $.AjaxDownloader({
                        url: url_pv + 'Flujodepagosdirector/download_file/',
                        data: {
                            cod: cod,
                            token: token_actual.token
                        }
...
function cargar_evaluaciones(token_actual, id_propuesta) {
    ...
    $.ajax({
        type: 'GET',
        url: url_pv + 'Flujodepagosdirector/all_evaluaciones/propuesta/' + id_propuesta,
        data: {"token": token_actual.token,
...
function aprobar_pago_ganador_director(token_actual, id_propuesta, observacion_verificacion_director) {
    $.ajax({
        ...
        data: "&modulo=SICON-PAGOS-DIRECTOR&token=" + token_actual.token
...
function devolver_al_misional(token_actual, id_propuesta, observacion_verificacion_director) {
    $.ajax({
        type: 'PUT',
        url: url_pv + 'Flujodepagosdirector/devolver_al_misional/propuesta/' + id_propuesta,
        data: "&modulo=SICON-PAGOS-DIRECTOR&token=" + token_actual.token
                + "&observacion_verificacion_director=" + observacion_verificacion_director
