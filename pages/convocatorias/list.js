keycloak.init(initOptions).then(function (authenticated) {
    ...
    } else
    {
        ...
        if (typeof keycloak === 'object') {
            ...
            permiso_lectura_keycloak(token_actual.token, "SICON-CONVOCATORIAS-BUSQUEDA");
                ...
                "drawCallback": function (settings) {
                    ...
                    $('.convocatoria_cancelar').click(function () {
                        ...
                        if ($("#convocatoria_diferente").val() == "t")
                        {
                            $.ajax({
                                type: 'GET',
                                data: {"modulo": "SICON-CONVOCATORIAS-BUSQUEDA", "token": token_actual.token, "id": $("#convocatoria_cancelar").val()},
                    ...
                    $('#publicar_convocatoria').click(function () {
                        ...
                        $.ajax({
                            type: 'POST',
                            data: {"token": token_actual.token, "modulo": "SICON-CONVOCATORIAS-PUBLICAR", "id": $("#convocatoria_publicar").val()},
                    ...
                    $('#cancelar_convocatoria').click(function () {
                        ...
                        $.ajax({
                            type: 'POST',
                            data: {"token": token_actual.token, "modulo": "SICON-CONVOCATORIAS-CANCELAR", "id": convocatoria_cancelar},
...
function acciones_convocatoria(token_actual)
{
    ...
    $(".activar_categoria").click(function () {
        ...
        $.ajax({
            type: 'DELETE',
            data: {"token": token_actual.token, "modulo": "SICON-CONVOCATORIAS-BUSQUEDA", "active": active},
