    ...
    } else
    {
        ...
        if (typeof keycloak === 'object') {
            ...
            $("#html_guardar").click(function () {
                ...
                {
                    var values_html = {modulo: "SICON-AJUSTAR-CONVOCATORIAS", "variable": $("#variable").val(), value_CKEDITOR: CKEDITOR.instances.html_general.getData(), token: token_actual.token};
                ...
                } else
                {
                    if ($("#id_tipo_participante").val() != "") {
                        ...
                        $.ajax({
                            ...
                            data: "active=TRUE&descripcion_perfil=" + CKEDITOR.instances.descripcion_cp.getData() + "&convocatoria=" + $("#id").val() + "&tipo_participante=" + $("#id_tipo_participante").val() + "&modulo=SICON-AJUSTAR-CONVOCATORIAS&token=" + token_actual.token
                        }).done(function (result) {
                        ...
                        $('.tipo_participante').click(function () {
                            if ($(this).prop('checked')) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: url_pv + 'Convocatoriasparticipantes/new/',
                                    data: "convocatoria=" + $("#id").val() + "&tipo_participante=" + $(this).val() + "&modulo=SICON-AJUSTAR-CONVOCATORIAS&token=" + token_actual.token
                                }).done(function (result) {
                            ...
                            } else
                            {
                                ...
                                $.ajax({
                                    type: 'DELETE',
                                    data: {"token": token_actual.token, "modulo": "SICON-AJUSTAR-CONVOCATORIAS", "convocatoria": $("#id").val(), "tipo_participante": $(this).val()},
    ...
    $('.form_validator_bolsa').bootstrapValidator({
        ...
        if ($("#id_bolsa").val() == "") {
            ...
            $.ajax({
                ...
                data: $form.serialize() + "&modulo=SICON-AJUSTAR-CONVOCATORIAS&token=" + token_actual.token + "&convocatoria=" + $("#id").attr('value')
            }).done(function (result) {
