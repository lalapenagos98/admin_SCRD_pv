...
//        limpiarFormulario();
    ...
    $("#aprobar_pago_asesor").click(function () {
        aprobar_pago_ganador_asesor(token_actual, $('#id_propuesta_asesor').val(), $('#observacion_verificacion_asesor').val());
//        limpiarFormulario();
    });

    //Para devolver documentación

    $("#devolver_al_misional_asesor").click(function () {
        devolver_al_misional(token_actual, $('#id_propuesta_asesor').val(), $('#observacion_verificacion_asesor').val());
//        limpiarFormulario();
    });
    ...
    if (authenticated === false) {
        ...
        if (typeof keycloak === 'object') {
            ...
            permiso_lectura_keycloak(token_actual.token, "SICON-PAGOS-ASESOR");
...
function init(token_actual) {
    ...
    $.ajax({
        ...
        url: url_pv + 'Flujodepagosasesor/init/'
    }).done(function (data) {
...
function cargar_select_convocatorias(token_actual, anio, entidad) {
    ...
    $.ajax({
        type: 'POST',
        url: url_pv + 'Flujodepagosasesor/select_convocatorias',
...
function cargar_select_categorias(token_actual, convocatoria) {
    ...
    $.ajax({
        type: 'POST',
        url: url_pv + 'Flujodepagosasesor/select_categorias',
...
function cargar_select_grupos(token_actual, ronda) {
    ...
    $.ajax({
        type: 'GET',
        url: url_pv + 'Flujodepagosasesor/select_grupos',
...
function cargar_tabla(token_actual) {
    ...
    $('#table_list').DataTable({
        ...
        "ajax": {
            type: 'POST',
            url: url_pv + "Flujodepagosasesor/all_propuestas_ganadoras",
            data:
...
function cargar_info_basica(token_actual, id_propuesta) {
    ...
    $.ajax({
        type: 'POST',
        url: url_pv + 'Flujodepagosasesor/propuestas_ganadoras/' + id_propuesta,
        data: {"token": token_actual.token},
    }).done(function (data) {
        ...
        switch (data) {
            ...
            default:
                ...
                if (json.propuesta) {
                    ...
                    $("#id_propuesta_asesor").attr("value", json.propuesta.id);
                    ...
                    $("#monto_asignado").attr("value", json.propuesta.monto_asignado);
                    $("#observacion_verificacion_asesor").attr("value", json.propuesta.observaciones_documentos_asesor);
...
//                                                $("#actualizar_parametro_otros").show();
                ...
                $(".download_file").click(function () {
                    ...
                    $.AjaxDownloader({
                        url: url_pv + 'Flujodepagosasesor/download_file/',
                        data: {
                            cod: cod,
                            token: token_actual.token
                        }
...
function cargar_evaluaciones(token_actual, id_propuesta) {
    ...
    $.ajax({
        type: 'GET',
        url: url_pv + 'Flujodepagosasesor/all_evaluaciones/propuesta/' + id_propuesta,
        data: {"token": token_actual.token,
...
function aprobar_pago_ganador_director(token_actual, id_propuesta, observacion_verificacion_director) {
    $.ajax({
        type: 'PUT',
        url: url_pv + 'Flujodepagosdirector/aprobar_pago_ganador_director/propuesta/' + id_propuesta,
        data: "&modulo=Flujo de Pagos Director Fomento&token=" + token_actual.token
                + "&observacion_verificacion_director=" + observacion_verificacion_director
        ...
        switch (data) {
            ...
            case 'error_estado_ganadores_subsanar':
                ...
                break;
            case 'error_observacion_verificacion_director':
...
function aprobar_pago_ganador_asesor(token_actual, id_propuesta, observacion_verificacion_asesor) {

    $.ajax({
        type: 'PUT',
        url: url_pv + 'Flujodepagosasesor/aprobar_pago_ganador_asesor/propuesta/' + id_propuesta,
        data: "&modulo=SICON-PAGOS-ASESOR&token=" + token_actual.token
                + "&observacion_verificacion_asesor=" + observacion_verificacion_asesor
        ...
        switch (data) {
            ...
            case 'error_estado_ganadores_subsanar':
                notify("danger", "remove", "Usuario:", "La documentación ya fue enviada a subsanar");
                break;
            case 'error_observacion_verificacion_asesor':
                notify("danger", "remove", "Usuario:", "Debe agregar una descripción de la verificación");
                break;
            default:
                notify("success", "ok", "Usuario:", "Se aprobó el pago con éxito.");
...
function devolver_al_misional(token_actual, id_propuesta, observacion_verificacion_asesor) {
    $.ajax({
        type: 'PUT',
        url: url_pv + 'Flujodepagosasesor/devolver_al_misional/propuesta/' + id_propuesta,
        data: "&modulo=SICON-PAGOS-ASESOR&token=" + token_actual.token
                + "&observacion_verificacion_asesor=" + observacion_verificacion_asesor
